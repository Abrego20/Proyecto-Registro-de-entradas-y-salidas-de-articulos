...
<div class="container mt-5" style="background: #1a1a2e; border-radius: 20px; padding: 30px; box-shadow: 0 8px 16px rgba(0, 0, 0, 0.6);">
    <h1 class="text-center" style="color: #0fbcf9; font-family: 'Orbitron', sans-serif;">Actualizacion de Categoría</h1>
    <h5 class="text-center" style="color: #a6a9b6; font-family: 'Roboto', sans-serif;">Formulario de Categorías</h5>
    <hr style="border: 1px solid #0fbcf9;">

    <form class="row g-4">
        <div class="col-md-6">
            <label for="nombre" class="form-label" style="color: #f1f1f1;">Nombre</label>
            <input type="text" class="form-control" id="nombre" placeholder="Nombre de la categoría" required style="background: transparent; border: 1px solid #0fbcf9; color: #f1f1f1; border-radius: 10px;">
        </div>
        <div class="col-12">
            <label for="descripcion" class="form-label" style="color: #f1f1f1;">Descripción</label>
            <textarea class="form-control" id="descripcion" placeholder="Descripción de la categoría" required style="background: transparent; border: 1px solid #0fbcf9; color: #f1f1f1; border-radius: 10px;"></textarea>
        </div>
        <div class="col-md-6">
