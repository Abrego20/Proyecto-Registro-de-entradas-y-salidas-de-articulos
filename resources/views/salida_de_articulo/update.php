...
{{-- Definimos el título --}}
@section('title', 'Crear salida de Artículo')
...
<div class="container mt-5" style="background: #1a1a2e; border-radius: 20px; padding: 30px; box-shadow: 0 8px 16px rgba(0, 0, 0, 0.6);">
    <h1 class="text-center" style="color: #0fbcf9; font-family: 'Orbitron', sans-serif;">Actualizacion  de salida de Artículo</h1>
    ...
    <form class="row g-4">
        <div class="col-md-6">
            <label for="nombre" class="form-label" style="color: #f1f1f1;">Cantidad</label>
        ...
        <div class="col-md-6">
            <label for="precio" class="form-label" style="color: #f1f1f1;">Precio Venta</label>
        ...
        <div class="col-12">
            <label for="stock" class="form-label" style="color: #f1f1f1;">usuario_registro</label>
        ...
        <div class="col-md-6">
            <label for="fecha_creacion" class="form-label" style="color: #f1f1f1;">Fecha Salidad</label>
